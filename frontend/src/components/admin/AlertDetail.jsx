  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <div className="flex items-center justify-between">
        <button
          onClick={onBack}
          className="px-3 py-1.5 rounded-lg bg-white border border-slate-200 text-slate-700 hover:text-slate-900 hover:bg-slate-50 flex items-center space-x-1.5 text-xs font-semibold shadow-xs"
        >
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xs font-mono font-semibold px-3 py-1 rounded-md bg-white text-slate-800 border border-slate-200 shadow-xs">
            {alert.status}
          </span>
        </div>
      </div>
            ...
            <div className="p-5 rounded-xl bg-white border border-slate-200 shadow-card space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200">
                  ...
                  <span className="text-sm font-bold text-slate-950 font-mono">{formatCurrency(transaction.amount)}</span>
                </div>
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200">
