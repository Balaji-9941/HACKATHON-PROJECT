    ...
    <div className="space-y-4 animate-fade-in">
      <div>
        <h3 className="text-sm font-bold text-slate-900 flex items-center space-x-2">
          ...
          <span>Live Judge Scenario Injector Panel</span>
        </h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
        {scenarios.map((scen) => {
          ...
          return (
            <div
              key={scen.id}
              className={`p-4 rounded-xl bg-white border ${scen.border} hover:shadow-card-hover transition space-y-3 flex flex-col justify-between shadow-card`}
            >
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className={`w-8 h-8 rounded-lg ${scen.color} flex items-center justify-center`}>
              ...
              <button
                ...
                className="w-full py-2 rounded-lg bg-slate-50 hover:bg-blue-50 disabled:opacity-50 border border-slate-200 hover:border-blue-200 text-slate-800 hover:text-blue-700 font-semibold text-xs flex items-center justify-center space-x-1.5 transition active:scale-95 shadow-xs"
              >
