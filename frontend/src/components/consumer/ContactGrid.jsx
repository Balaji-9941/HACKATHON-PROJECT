  ...
  return (
    <div className="space-y-2.5">
      ...
      <div className="flex space-x-3 overflow-x-auto pb-1 scrollbar-none">
        ...
        >
          <div className="w-13 h-13 rounded-full border border-dashed border-slate-300 group-hover:border-blue-600 flex items-center justify-center bg-white text-slate-500 group-hover:text-blue-600 transition shadow-xs">
        ...
        {contacts.map((contact, idx) => (
          <button
            ...
            className="flex flex-col items-center justify-center min-w-[68px] space-y-1.5 group"
          >
            <div className="w-13 h-13 rounded-full overflow-hidden border border-slate-200 group-hover:border-blue-600 group-hover:scale-105 transition bg-slate-100 flex items-center justify-center text-sm font-bold text-slate-800 shadow-xs">
            ...
            <span className="text-[11px] text-slate-700 font-semibold truncate w-16 text-center group-hover:text-blue-700">
