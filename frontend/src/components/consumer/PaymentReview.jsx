...
import { ArrowLeft, ShieldCheck, ShieldAlert, AlertTriangle, ArrowRight, Building, MapPin, Smartphone } from 'lucide-react';
    ...
    <div className="space-y-4 animate-fade-in text-slate-900">
      ...
      <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-card space-y-3">
        <div className="flex items-center space-x-3">
          <div className="w-11 h-11 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-base font-bold text-slate-800">
